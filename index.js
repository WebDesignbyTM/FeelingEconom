...
var budgetController=(function()
{
	...
	return {
		...
		calculatePercentages:function() {
			data.allItems.exp.forEach(function(crt) {
				crt.calcPercentage(data.totals.inc);
			});
		},
		getBudget:function() {
			return {
		...
		getPercentages:function() {
			var allPercentages=data.allItems.exp.map(function(crt){
				return crt.getPercentage();
			});
...
var UIController=(function() {
	...
	return {
        ...
        displayPercentages: function(percentages)
        {
        	...
        	nodeListForEach(fields, function(crt,ind) {
        		if(percentages[ind]>0) {
        			crt.textContent=percentages[ind]+'%';
        		}else {
        			crt.textContent='---';
        		}
        	});
        ...
        changedType: function() {
        	...
        	nodeListForEach(fields,function(crt) {
        		crt.classList.toggle('red-focus');
        	});
